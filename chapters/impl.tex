...
\subsection{A komponensek tesztelése}

A tesztelés első fázisában az egyes komponensek kerültek tesztelésre. Az alábbiakban felsorolászerűen szerepelnek a tesztelt függvények, és a függvényenkénti tesztelési szempontok. A tesztesetek kézzel készültek a megadott szempontok alapján. Az egyes modulokhoz tartozó tesztesetek a \textit{Test.<modulnév>} modulokban találhatók. Mindegyik tesztmodul exportál egy \textit{run<modulnév>Test :: IO ()} akciót, amely a standard outputra logolja a tesztelés eredményét. \textbf{IDE MÉG ÍROK, HA TÉNYLEGESEN KÉSZ LESZNEK A TESZTEK.}
...
A szoftver komponensei az összes teszten átmentek.

\subsection{Felhasználói tesztek}

A tesztelés második fázisában került tesztelésre a szoftver tényleges működése. A felhasználói tesztelés kézzel történt az alább, felsorolásszerűen leírt szempontok alapján. Vastag betűvel jelzem a nem teljesített teszteseteket.
