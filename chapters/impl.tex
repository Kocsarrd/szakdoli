...
\lstset{caption={A Gui típus}, label=src:hs}
\begin{lstlisting}[language={Haskell}]
...
Az \textit{id}-től függő cellák esetén (ezek szükségszerűen formulák) azt kell ellenőrizni, hogy sikerült-e parseolni. (Ez ekvivalens azzal, hogy a \textit{\_value} értéke \textit{Just}.
