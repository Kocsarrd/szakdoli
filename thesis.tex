...
% Dolgozat metaadatai
% Document's metadata
\title{Táblázatkezelő szoftver implementálása Haskell nyelven} % cím / title
...
\supervisor{Dr. Kaposi Ambrus} % belső témavezető neve / internal supervisor's name
...
\newcommand{\hungarianchaptername}{Fejezet}
\newcommand{\hungariancontentsname}{Tartalomjegyzék}
\newcommand{\hungarianfigurename}{Ábra}
\newcommand{\hungariantablename}{Táblázat}
% A dolgozat
% The document
\begin{document}
